...
{
    /// <inheritdoc />
    public partial class SocialModuleAndUserProfileRefactor : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Follows_Follower_Following", "[FollowerId] <> [FollowingId]");
                    table.ForeignKey(
            ...
            migrationBuilder.Sql("""
                INSERT INTO Profiles (UserId, FullName, AvatarUrl, Bio, ClassName, Major, Interests, CreatedAt, UpdatedAt)
                SELECT U.Id, NULL, U.AvatarUrl, U.Bio, NULL, NULL, NULL, U.CreatedAt, U.UpdatedAt
                FROM Users U
                WHERE U.AvatarUrl IS NOT NULL OR U.Bio IS NOT NULL
                """);
